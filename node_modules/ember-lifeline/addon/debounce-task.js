...
/**
   ...
   @public
   */
export function debounceTask(destroyable, name, ...debounceArgs) {
    ...
    assert(`Called \`debounceTask\` on destroyed object: ${destroyable}.`, !destroyable.isDestroyed);
...
/**
   ...
   @public
   */
export function cancelDebounce(destroyable, name) {
