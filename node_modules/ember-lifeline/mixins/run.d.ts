...
declare const _default: Mixin<{
    /**
     ...
     @public
     */
    runTask(taskOrName: any, timeout?: number): EmberRunTimer;
    /**
    ...
    /**
     ...
     @public
     */
    scheduleTask(queueName: any, taskOrName: any, ...args: any[]): EmberRunTimer;
    /**
     ...
     @public
     */
    debounceTask(name: any, ...debounceArgs: any[]): void;
    /**
    ...
    /**
     ...
     @public
     */
    throttleTask(name: any, timeout: any): EmberRunTimer;
    /**
     ...
     @public
     */
    cancelThrottle(cancelId: any): void;
    /**
     ...
     @public
     */
    pollTask(taskOrName: any, token: any): string | number;
    /**
